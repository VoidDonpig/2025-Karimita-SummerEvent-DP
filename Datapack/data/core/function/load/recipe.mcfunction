...
# set data
    ...
    # weapon
        ...
        [\
        {"result":"weapon/melee/sword_of_braveness","count":1,"recipe_components":[{"name":"minecraft:netherite_sword","count":1,"custom":0,custom_data:{}},{"name":"minecraft:netherite_ingot","count":4,"custom":0,custom_data:{}}],\
        grecipe:[\
