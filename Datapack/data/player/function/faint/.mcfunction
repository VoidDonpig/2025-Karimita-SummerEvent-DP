...
# summon mannequin
    # get data
        data modify storage player: __temp__.x set from entity @s respawn.pos[0]
        data modify storage player: __temp__.y set from entity @s respawn.pos[1]
        data modify storage player: __temp__.z set from entity @s respawn.pos[2]
        data modify storage player: __temp__.dimension set from entity @s respawn.dimension
