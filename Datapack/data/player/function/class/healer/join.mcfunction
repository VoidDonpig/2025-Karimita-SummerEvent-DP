...
# join team
    team join class.healer @s
    execute if score @s class.healer.level matches 30..49 run team join class.healer_1 @s
    execute if score @s class.healer.level matches 50 run team join class.healer_2 @s
    execute if score @s class.knight.level matches 50 if score @s class.archer.level matches 50 if score @s class.archer.level matches 50 if score @s class.wizard.level matches 50 if score @s class.healer.level matches 50 run team join class.healer_3 @s
