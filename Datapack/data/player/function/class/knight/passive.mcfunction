...
# calculation
    scoreboard players set $max_health temporary 25
    scoreboard players set $knockback_resistance temporary 2
    scoreboard players set $attack_range temporary 20
    scoreboard players set $movement_speed temporary 1
    scoreboard players set $attack_damage temporary 2
    ...
    scoreboard players operation $attack_damage temporary *= @s class.knight.level
...
# apply
    ...
    scoreboard players operation @s attack_damage += $movement_speed temporary
