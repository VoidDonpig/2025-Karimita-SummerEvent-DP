#> asset:mob/wither_emperor/init/data
#
# define the data
#
# @within asset:mob/wither_emperor/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Wither Emperor","color":"dark_red"}
...
# define attribute
    data modify storage mob:init data.health set value 1000000
    #data modify storage mob:init data.damage set value 600.0
