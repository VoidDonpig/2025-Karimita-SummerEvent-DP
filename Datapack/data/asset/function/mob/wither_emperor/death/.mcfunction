...
# death event
    ...
    execute unless score @s death_timer.1 matches 200.. if score @s death_timer.2 matches 1 run playsound entity.wither.hurt hostile @a ~ ~ ~ 16 0.8 0
    execute unless score @s death_timer.1 matches 200.. if score @s death_timer.2 matches 1 run particle explosion_emitter ~ ~9.0 ~ 16.0 16.0 16.0 0 256 force @a

    execute if score @s death_timer.2 matches 5 run scoreboard players reset @s death_timer.2

    execute if score @s death_timer.1 matches 200 run playsound entity.wither.death hostile @a ~ ~ ~ 16 0.5 0
    execute if score @s death_timer.1 matches 200 run particle explosion_emitter ~ ~9.0 ~ 16.0 16.0 16.0 0 8192 force @a
