#> asset:mob/wither_combatant/init/data
#
# define the data
#
# @within asset:mob/wither_combatant/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Wither Combatant","color":"red"}
    ...
    data modify storage mob:init data.PersistenceRequired set value 0b

    #data modify storage mob:init data.NoAI set value 1b

# define attribute
    data modify storage mob:init data.health set value 30
    ...
    #data modify storage mob:init data.scale set value 5.8
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 40
    data modify storage mob:init data.loot.gold set value 8
