#> asset:mob/torn_live/init/data
#
# define the data
#
# @within asset:mob/torn_live/init/

# set data
    data modify storage mob:init data.CustomName set value {"text": "Torn Live","color": "red"}
    ...
    data modify storage mob:init data.equipment.head set value {"id":"minecraft:player_head","components":{"minecraft:profile":{properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjQ5ZjI4YTNkZWZiMWU5YjQ5OWUwMjY3ZDA0YWU5NmVmMjE3Yjc0NWZlYTZiODVlMDdkNGU2NDI5ODhhMzY2NiJ9fX0"}]}}}
    data modify storage mob:init data.equipment.chest set value {"id":"leather_chestplate","components":{unbreakable:{},dyed_color:10223616}}
    data modify storage mob:init data.equipment.legs set value {"id":"leather_leggings","components":{unbreakable:{},dyed_color:10223616}}
    data modify storage mob:init data.equipment.feet set value {"id":"leather_boots","components":{unbreakable:{},dyed_color:5373952}}
    #data modify storage mob:init data.equipment.mainhand set value {"id":""}
...
# define attribute
    data modify storage mob:init data.health set value 3300.0
    data modify storage mob:init data.damage set value 45.0
    ...
    data modify storage mob:init data.movement_speed set value 0.32
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 1200
    data modify storage mob:init data.loot.gold set value 180
