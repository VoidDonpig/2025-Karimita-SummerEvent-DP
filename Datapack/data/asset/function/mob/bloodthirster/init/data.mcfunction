#> asset:mob/bloodthirster/init/data
#
# define the data
#
...
# set data
    data modify storage mob:init data.CustomName set value {"text": "Bloodthirster","color": "red"}
...
# define attribute
    data modify storage mob:init data.health set value 80.0
    data modify storage mob:init data.damage set value 30.0
    data modify storage mob:init data.attack_knockback set value 1.4
    data modify storage mob:init data.knockback_resistance set value 0.6
    data modify storage mob:init data.movement_speed set value 0.3
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 100
    data modify storage mob:init data.loot.gold set value 60
