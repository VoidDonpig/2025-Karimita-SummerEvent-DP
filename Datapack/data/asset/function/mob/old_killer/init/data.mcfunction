#> asset:mob/old_killer/init/data
#
# define the data
#
# @within asset:mob/old_killer/init/

# set data
    data modify storage mob:init data.CustomName set value {"text": "Old Killer","color": "red"}
...
# define attribute
    data modify storage mob:init data.health set value 4600.0
    data modify storage mob:init data.damage set value 75.0
