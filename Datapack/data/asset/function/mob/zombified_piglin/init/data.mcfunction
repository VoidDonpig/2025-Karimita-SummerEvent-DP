#> asset:mob/zombified_piglin/init/data
#
# define the data
#
# @within asset:mob/zombified_piglin/init/
...
# define attribute
    ...
    #data modify storage mob:init data.zombified_piglin_spawn_reinforcements set value 1.0
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 25
