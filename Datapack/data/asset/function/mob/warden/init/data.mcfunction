#> asset:mob/warden/init/data
#
# define the data
#
# @within asset:mob/warden/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Warden","bold":true,"color":"#0A494F"}
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 40000
    data modify storage mob:init data.loot.gold set value 3850
