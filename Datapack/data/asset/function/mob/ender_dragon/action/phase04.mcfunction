...
# run special action when not done
    execute unless entity @s[tag=asset.mob.ender_dragon.phase04.special_action_done] run function asset:mob/ender_dragon/action/phase_special_action/phase04
    execute unless entity @s[tag=asset.mob.ender_dragon.phase04.special_action_done] run return fail
