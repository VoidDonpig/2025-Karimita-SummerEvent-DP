...
# ender flame
    execute unless score @s ai_counter.1 matches 4 if predicate lib:periodic/35 positioned ^ ^ ^-5 as @a[distance=..128,tag=!player.exception] run function asset:mob/ender_dragon/action/ender_flame/
