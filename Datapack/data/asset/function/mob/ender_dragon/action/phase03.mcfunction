...
# movement
    function asset:mob/ender_dragon/base_move_03
...
# ender flame
    execute if predicate lib:periodic/10 positioned ^ ^ ^-5 as @a[distance=..128,tag=!player.exception] run function asset:mob/ender_dragon/action/ender_flame/
...
# void apocalypse
    execute if score @s ai_timer.1 matches 580 run function asset:mob/ender_dragon/action/void_apocalypse/

# reset
    scoreboard players reset @s[scores={ai_timer.1=780..}] ai_timer.1