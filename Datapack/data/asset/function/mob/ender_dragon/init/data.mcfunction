#> asset:mob/ender_dragon/init/data
#
# define the data
#
# @within asset:mob/ender_dragon/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Ender Dragon","bold":true,"color":"#c800fa"}
...
# define attribute
    data modify storage mob:init data.health set value 4500
