#> asset:mob/stray/action/swap_weapon/ranged
#
# grab ranged weapon
#
...
# sfx
    ...
    playsound item.armor.equip_leather hostile @a[distance=..16] ~ ~ ~ 1 1
...
# grab bow
    ...
    execute if score $difficulty_level world matches 2 run item replace entity @s weapon.mainhand with bow[enchantments={power:2}]