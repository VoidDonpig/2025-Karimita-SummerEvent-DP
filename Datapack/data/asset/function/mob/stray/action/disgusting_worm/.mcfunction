#> asset:mob/stray/action/disgusting_worm/
#
# shoot silverfish
#
# @within asset:mob/stray/tick/have_target
...
# summon silverfish
    # $difficulty_level=..4
        function asset:mob/stray/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__
    # $difficulty_level=5
        function asset:mob/stray/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__.0
        function asset:mob/stray/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__.1
        function asset:mob/stray/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__.2
