#> asset:mob/zombie_villager/init/data
#
# define the data
#
# @within asset:mob/zombie_villager/init/
...
# define attribute
    ...
    #data modify storage mob:init data.zombie_villager_spawn_reinforcements set value 1.0
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 7
    data modify storage mob:init data.loot.gold set value 2
