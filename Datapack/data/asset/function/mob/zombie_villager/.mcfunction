...
# leap attack
    ...
    # caution
        execute if score @s ai_timer.1 matches 30 run function asset:mob/zombie_villager/action/leap_attack/caution
    ...
    # run
        execute if score @s ai_timer.1 matches 40 rotated ~ 0 run function asset:mob/zombie_villager/action/leap_attack/
    # reset
...
# undead healing
    ...
    # run
        execute if score @s ai_timer.2 matches 200 run function asset:mob/zombie_villager/action/undead_healing/
    # reset
...
# shredding infection
    ...
    # caution
        execute if score @s ai_timer.4 matches 70 run function asset:mob/zombie_villager/action/shredding_infection/caution
    # keep adding 
        execute if score @s ai_timer.4 matches 70.. unless entity @s[tag=leap_attack.doing] run scoreboard players add @s ai_timer.4 1
    # run
        execute if score @s ai_timer.4 matches 100 run function asset:mob/zombie_villager/action/shredding_infection/
    # add count score
...
# carnivorous instinct
    ...
    # run
        execute if score @s ai_timer.5 matches 60 run function asset:mob/zombie_villager/action/carnivorous_instinct/
    # add count score
...
# throw axe
    ...
    # caution
        execute if score @s ai_timer.6 matches 80 run function asset:mob/zombie_villager/action/throw_axe/caution
    # keep adding score
        execute if score @s ai_timer.6 matches 80.. run scoreboard players add @s ai_timer.6 1
    # run
        execute if score @s ai_timer.6 matches 100 run function asset:mob/zombie_villager/action/throw_axe/
    # reset
