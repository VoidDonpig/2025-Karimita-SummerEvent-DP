#> asset:mob/demiurge/init/data
#
# define the data
#
# @within asset:mob/demiurge/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Demiurge","bold":true,"color":"white"}
...
# define attribute
    data modify storage mob:init data.health set value 25000000
