#> asset:mob/fallen_skeleton/init/data
#
# define the data
#
# @within asset:mob/fallen_skeleton/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Fallen Skeleton","color":"dark_gray"}
    ...
    data modify storage mob:init data.equipment.mainhand set value {"id":"bow","components":{"enchantments":{"minecraft:punch":10}}}
...
# define attribute
    data modify storage mob:init data.health set value 40
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 30
    data modify storage mob:init data.loot.gold set value 5
