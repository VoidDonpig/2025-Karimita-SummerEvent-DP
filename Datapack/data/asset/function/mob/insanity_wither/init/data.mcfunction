#> asset:mob/insanity_wither/init/data
#
# define the data
#
# @within asset:mob/insanity_wither/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Insanity Wither","bold":true,"color":"red"}
...
# define attribute
    data modify storage mob:init data.health set value 9999999
    ...
    #data modify storage mob:init data.AbsorptionAmount set value 9999999
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 100000
    data modify storage mob:init data.loot.gold set value 3500
