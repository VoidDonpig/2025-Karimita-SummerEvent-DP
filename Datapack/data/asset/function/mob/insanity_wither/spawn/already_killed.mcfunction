...
# spawn act
    ...
    execute if score @s dialogue_timer.1 matches 1 run tellraw @a [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "あcファ絵wfdァウェ３fvcあｗ","color": "red"}]
    execute if score @s dialogue_timer.1 matches 1 run data modify entity @s Invul set value 200
    execute if score @s dialogue_timer.1 matches 40 run tellraw @a [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "アｗセフェｆｃダファｃｖ４ｗｆエｗｆｃ","color": "red"}]
    execute if score @s dialogue_timer.1 matches 100 run tellraw @a [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "ｆｃわえｆｃうぇｆぁえｗｆｃ","color": "red"}]
    execute if score @s dialogue_timer.1 matches 160 run tellraw @a [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "あｗｃふぇかえｆゎえっせ","color": "red"}]
