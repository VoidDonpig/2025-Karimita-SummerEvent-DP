...
# spawn act
    ...
    execute if score @s dialogue_timer.1 matches 1 run tellraw @a[distance=..128] [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "ｃｆらうぇｔゔぇｃうぇｖうぇ","color": "red"}]
    execute if score @s dialogue_timer.1 matches 1 run data modify entity @s Invul set value 200
    execute if score @s dialogue_timer.1 matches 40 run tellraw @a[distance=..128] [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "あｗｖｃｔｃｘれｖｃ","color": "red"}]
    execute if score @s dialogue_timer.1 matches 100 run tellraw @a[distance=..128] [{"text": "[BOSS] Insanity Wither: ", "color": "dark_red"},{"text": "あｗｃｔｇｔｃｃｖｔｒゔぁべっｓｗｒ","color": "red"}]
