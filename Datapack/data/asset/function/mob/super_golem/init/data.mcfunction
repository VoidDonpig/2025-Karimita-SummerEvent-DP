#> asset:mob/super_golem/init/data
#
# define the data
#
# @within asset:mob/super_golem/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Super Golem","bold":true,"color":"gray"}
...
# define attribute
    data modify storage mob:init data.health set value 999999
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 0
    data modify storage mob:init data.loot.gold set value 0
