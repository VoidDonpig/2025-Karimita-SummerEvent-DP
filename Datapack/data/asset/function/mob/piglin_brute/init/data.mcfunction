#> asset:mob/piglin_brute/init/data
#
# define the data
#
# @within asset:mob/piglin_brute/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Piglin Brute","bold":true,"color":"red"}
...
# define attribute
    data modify storage mob:init data.health set value 2560
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 1250
    data modify storage mob:init data.loot.gold set value 550
