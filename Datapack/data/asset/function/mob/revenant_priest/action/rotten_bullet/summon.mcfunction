...
# sfx
    playsound entity.shulker.shoot hostile @a[distance=..16] ~ ~ ~ 2 0.7 0
    playsound entity.zombie.infect hostile @a[distance=..16] ~ ~ ~ 2 0.7 0
    playsound minecraft:entity.evoker.cast_spell hostile @a[distance=..16] ~ ~ ~ 2 1.4
