...
# spawn act
    ...
    execute if score @s dialogue_timer.1 matches 1 run tellraw @a [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "ああ..またお前か...","color": "red"}]
    execute if score @s dialogue_timer.1 matches 1 run data modify entity @s Invul set value 200
    execute if score @s dialogue_timer.1 matches 40 run tellraw @a [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "お前はいったい何を望む？","color": "red"}]
    execute if score @s dialogue_timer.1 matches 100 run tellraw @a [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "...まあ、そんなことはどうでもよいか。","color": "red"}]
    execute if score @s dialogue_timer.1 matches 160 run tellraw @a [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "さあ全てを終わらせよう。","color": "red"}]
