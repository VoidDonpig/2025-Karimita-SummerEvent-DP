#> asset:mob/wither/init/data
#
# define the data
#
# @within asset:mob/wither/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Wither","bold":true,"color":"dark_gray"}
...
# define attribute
    data modify storage mob:init data.health set value 13500
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 1000
    data modify storage mob:init data.loot.gold set value 350
