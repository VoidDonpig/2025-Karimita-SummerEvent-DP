...
# playsound
    ...
    execute if score @s dialogue_timer.1 matches 100 run playsound entity.wither.ambient hostile @a ~ ~ ~ 16 0.5 0
...
# wither impact
    ...
    execute if score @s ai_timer.2 matches 600..659 at @n[tag=target] run particle large_smoke ~ ~0.5 ~ 0.4 0.2 0.4 0.3 16 force @a[distance=..32]
    execute if score @s ai_timer.2 matches 600 at @n[tag=target] run playsound entity.wither.shoot hostile @a ~ ~ ~ 2 0.5 0
