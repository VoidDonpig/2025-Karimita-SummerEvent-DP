...
# message
    ...
    execute if score @s dialogue_timer.1 matches 1 run tellraw @a[distance=..128] [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "あまり調子に乗るんじゃないぞ。","color": "red"}]
    execute if score @s dialogue_timer.1 matches 40 run tellraw @a[distance=..128] [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "私の力は一撃で人間を葬り去ることができる。","color": "red"}]
    execute if score @s dialogue_timer.1 matches 100 run tellraw @a[distance=..128] [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "それがどんなものか見せてやろう！","color": "red"}]
...
# catastrophic lightning
    ...
    execute if score @s ai_timer.2 matches 400 if score $random temporary matches 0 run tellraw @a[distance=..128] [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "雷よ、奴を滅せよ！","color": "red"}]
    execute if score @s ai_timer.2 matches 400 if score $random temporary matches 1 run tellraw @a[distance=..128] [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "私のエネルギーはこの程度ではない。","color": "red"}]
    execute if score @s ai_timer.2 matches 400 if score $random temporary matches 2 run tellraw @a[distance=..128] [{"text": "[BOSS] Wither: ", "color": "dark_red"},{"text": "早々に諦めた方が楽に死ねるぞ。","color": "red"}]
    execute if score @s ai_timer.2 matches 400 run playsound entity.wither.ambient hostile @a[distance=..16] ~ ~ ~ 2 1 0
...
# curse of wither
    ...
    execute if score @s ai_timer.2 matches 600..800 run particle large_smoke ~ ~4.0 ~ 0.4 0.2 0.4 0 32 normal
    execute if score @s ai_timer.2 matches 600..800 run particle electric_spark ~ ~4.0 ~ 0.4 0.2 0.4 1 32 normal
    ...
    execute if score $interval temporary matches 0 run playsound block.bell.resonate hostile @a[distance=..16] ~ ~5.0 ~ 16 1 0
    execute if score $interval temporary matches 0 run playsound block.beacon.activate hostile @a[distance=..16] ~ ~5.0 ~ 16 0.5 0
    ...
    execute if score @s ai_timer.2 matches 600 run title @a[tag=wither_cursed] title {"text":"10","color":"dark_red"}
    ...
    execute if score @s ai_timer.2 matches 620 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 640 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 660 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 680 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 700 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 720 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 740 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 760 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 780 run title @a[tag=wither_cursed] subtitle {"text":"オーブに触れて呪いを浄化せよ！","color":"red"}
    ...
    execute if score @s ai_timer.2 matches 800 run playsound entity.lightning_bolt.thunder hostile @a[distance=..16] ~ ~ ~ 16 2 0
    execute if score @s ai_timer.2 matches 800 run playsound entity.zombie.break_wooden_door hostile @a[distance=..16] ~ ~ ~ 16 0.5 0
    execute if score @s ai_timer.2 matches 800 run playsound entity.lightning_bolt.thunder hostile @a[distance=..16] ~ ~ ~ 16 2 0
    execute if score @s ai_timer.2 matches 800 run playsound entity.zombie.break_wooden_door hostile @a[distance=..16] ~ ~ ~ 16 0.5 0
    execute if score @s ai_timer.2 matches 800 run playsound entity.lightning_bolt.thunder hostile @a[distance=..16] ~ ~ ~ 16 2 0
    execute if score @s ai_timer.2 matches 800 run playsound entity.zombie.break_wooden_door hostile @a[distance=..16] ~ ~ ~ 16 0.5 0
