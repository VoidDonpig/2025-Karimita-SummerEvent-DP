...
# sfx
    particle dust_color_transition{from_color:[0.878,0.969,0.576],scale:1,to_color:[0.2,0.2,0.2]} ~ ~10 ~ 0.2 5 0.2 1 256 normal
    particle minecraft:large_smoke ~ ~ ~ 0.2 0.2 0.2 0.1 4
    particle minecraft:explosion ~ ~ ~ 1 0.5 1 0 5 normal
    ...
    playsound minecraft:entity.blaze.shoot hostile @a[distance=..16] ~ ~ ~ 1 0.5
    playsound minecraft:entity.lightning_bolt.impact hostile @a[distance=..16] ~ ~ ~ 0.5 0.5 1
    playsound minecraft:entity.wither_skeleton.hurt hostile @a[distance=..16] ~ ~ ~ 1 0.7
