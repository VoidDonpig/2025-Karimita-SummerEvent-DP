#> asset:mob/wither/action/charge/move
#
# move
#
# @within asset:mob/wither/action/charge/

# detect moiving
    execute on vehicle at @s if function asset:mob/wither/collision_check run rotate @s ~ 0
    execute on vehicle at @s if function asset:mob/wither/collision_check run scoreboard players set @s ai_timer.1 30
