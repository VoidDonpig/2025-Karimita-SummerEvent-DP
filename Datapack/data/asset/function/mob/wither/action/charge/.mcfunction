#> asset:mob/wither/action/charge/
#
# move
#
...
# move to player
    execute if score @s ai_timer.1 matches ..15 run function asset:mob/wither/action/charge/move
...
# reset
    execute if score @s ai_timer.1 matches 25.. run function asset:mob/wither/action/charge/reset