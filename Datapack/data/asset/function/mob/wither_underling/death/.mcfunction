...
# sfx
    execute if score @s death_timer.1 matches 20 run particle minecraft:flame ~ ~1.5 ~ 0.2 0.2 0.2 0.3 32 normal
...
# summon soul
    ...
    execute if score @s death_timer.1 matches 20 run tag @n[type=armor_stand,tag=not_init,tag=withering_soul] remove not_init