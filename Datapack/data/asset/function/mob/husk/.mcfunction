...
# curse of husks
    ...
    # caution
        execute if score @s ai_timer.3 matches 80 run function asset:mob/husk/action/curse_of_husks/caution
    # keep adding score when charging
        execute if score @s ai_timer.3 matches 80.. unless entity @s[tag=leap_attack.doing] run scoreboard players add @s ai_timer.3 1
    # run
        execute if score @s ai_timer.3 matches 100 run function asset:mob/husk/action/curse_of_husks/
    # add count score
