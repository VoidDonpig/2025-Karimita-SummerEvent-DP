...
# leap attack
    ...
    # caution
        execute if score @s ai_timer.1 matches 30 run function asset:mob/husk/action/leap_attack/caution
    ...
    # run
        execute if score @s ai_timer.1 matches 40 rotated ~ 0 run function asset:mob/husk/action/leap_attack/
    # reset
...
# undead healing
    ...
    # run
        execute if score @s ai_timer.2 matches 200 run function asset:mob/husk/action/undead_healing/
    # reset
...
# curse of husks
    ...
    # caution
        execute if score @s ai_timer.3 matches 80 run function asset:mob/husk/action/curse_of_zombies/caution
    # keep adding score when charging
        execute if score @s ai_timer.3 matches 80.. unless entity @s[tag=leap_attack.doing] run scoreboard players add @s ai_timer.3 1
    # run
        execute if score @s ai_timer.3 matches 100 run function asset:mob/husk/action/curse_of_zombies/caution
    # add count score
...
# shredding infection
    ...
    # caution
        execute if score @s ai_timer.4 matches 70 run function asset:mob/husk/action/shredding_infection/caution
    # keep adding 
        execute if score @s ai_timer.4 matches 70.. unless entity @s[tag=leap_attack.doing] run scoreboard players add @s ai_timer.4 1
    # run
        execute if score @s ai_timer.4 matches 100 run function asset:mob/husk/action/shredding_infection/
    # add count score
...
# carnivorous instinct
    ...
    # run
        execute if score @s ai_timer.5 matches 60 run function asset:mob/husk/action/carnivorous_instinct/
    # add count score
...
# throw axe
    ...
    # caution
        execute if score @s ai_timer.6 matches 80 run function asset:mob/husk/action/throw_axe/caution
    # keep adding score
        execute if score @s ai_timer.6 matches 80.. run scoreboard players add @s ai_timer.6 1
    # run
        execute if score @s ai_timer.6 matches 100 run function asset:mob/husk/action/throw_axe/
    # reset
