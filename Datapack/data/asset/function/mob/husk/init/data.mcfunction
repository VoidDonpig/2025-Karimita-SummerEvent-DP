#> asset:mob/husk/init/data
#
# define the data
#
# @within asset:mob/husk/init/
...
# define attribute
    ...
    #data modify storage mob:init data.husk_spawn_reinforcements set value 1.0
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 6
    data modify storage mob:init data.loot.gold set value 1
