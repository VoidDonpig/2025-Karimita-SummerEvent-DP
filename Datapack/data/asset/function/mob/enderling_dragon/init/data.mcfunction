#> asset:mob/enderling_dragon/init/data
#
# define the data
#
# @within asset:mob/enderling_dragon/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Enderling Dragon","color":"#c800fa","bold":true}
...
# define attribute
    data modify storage mob:init data.health set value 200
    ...
    data modify storage mob:init data.scale set value 0.0625
