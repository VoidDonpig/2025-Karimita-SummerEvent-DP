...
# summon arrow ($difficulty_level=..4)
    execute if score $difficulty_level world matches ..4 run function asset:mob/wither_skeleton/action/rapid_fire/summon_arrow with storage asset:mob __temp__
