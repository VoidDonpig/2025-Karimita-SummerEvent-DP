#> asset:mob/wither_skeleton/action/disgusting_worm/
#
# shoot silverfish
#
...
# set direction
    # $difficulty_level=..4
        # set Pos
            execute if score $difficulty_level world matches 1..4 in world:admin_area positioned 0.0 0.0 0.0 run tp 83a-51-1-0-0 ^ ^ ^3.0
        # record motion from Pos
            execute if score $difficulty_level world matches 1..4 in world:admin_area run data modify storage asset:mob __temp__.motion set from entity 83a-51-1-0-0 Pos
    # $difficulty_level=5
        # right direction
            # set Pos
...
# summon silverfish
    # $difficulty_level=..4
        function asset:mob/wither_skeleton/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__
    # $difficulty_level=5
        function asset:mob/wither_skeleton/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__.0
        function asset:mob/wither_skeleton/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__.1
        function asset:mob/wither_skeleton/action/disgusting_worm/summon_silverfish with storage asset:mob __temp__.2
