#> asset:mob/enderman/init/data
#
# define the data
#
# @within asset:mob/enderman/init/
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 44
    data modify storage mob:init data.loot.gold set value 12
