#> asset:mob/piglin/init/data
#
# define the data
#
# @within asset:mob/piglin/init/
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 20
    data modify storage mob:init data.loot.gold set value 4
