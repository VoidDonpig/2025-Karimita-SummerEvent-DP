#> asset:mob/voidling_zealot/init/data
#
# define the data
#
# @within asset:mob/voidling_zealot/init/

# set data
    data modify storage mob:init data.CustomName set value ["",{"text":"Voidling Zealot","color":"dark_purple","bold":true}]
    data modify storage mob:init data.CustomNameVisible set value 1b

    data modify storage mob:init data.active_effects set value [{id:"resistance",duration:-1,"amplifier":0,"show_particles":false}]
...
# define attribute
    data modify storage mob:init data.health set value 86.0
    data modify storage mob:init data.damage set value 20.0
    data modify storage mob:init data.attack_knockback set value 4.0
    data modify storage mob:init data.knockback_resistance set value 0.2
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 120
