#> asset:mob/magma_cube/init/data
#
# define the data
#
# @within asset:mob/magma_cube/init/
...
# define attribute
    data modify storage mob:init data.health set value 81.0
...
# define loot
    ...
    data modify storage mob:init data.loot.gold set value 15
