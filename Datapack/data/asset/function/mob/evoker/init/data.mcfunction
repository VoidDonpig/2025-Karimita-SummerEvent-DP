#> asset:mob/evoker/init/data
#
# define the data
#
# @within asset:mob/evoker/init/

# set data
    data modify storage mob:init data.CustomName set value {"text":"Evoker","bold":true,"color":"gray"}
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 3500
    data modify storage mob:init data.loot.gold set value 200
