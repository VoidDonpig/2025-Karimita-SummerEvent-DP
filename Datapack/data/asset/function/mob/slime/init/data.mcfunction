#> asset:mob/slime/init/data
#
# define the data
#
# @within asset:mob/slime/init/
...
# define attribute
    data modify storage mob:init data.health set value 25
...
# define loot
    data modify storage mob:init data.loot.combat_exp set value 8
...
# set size
    data modify entity @s Size set value 4b