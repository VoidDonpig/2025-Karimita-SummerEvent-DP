...
# shoot arrows
    ...
    execute in world:admin_area positioned 0.0 0.0 0.0 run tp 83a-51-1-0-0 ^0.1 ^ ^2.4
    execute as @n[tag=not_init_arrow,tag=artemis_armor_arrow] run data modify entity @s Motion set from entity 83a-51-1-0-0 Pos
