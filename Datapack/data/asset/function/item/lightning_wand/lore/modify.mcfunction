...
# copy item
    data modify storage asset: lightning_wand set from storage asset: Inventory[0]

# updates shulker box
    data modify storage asset: __temp__.Slot set string storage asset: lightning_wand.Slot 0 -1
    data remove storage asset: lightning_wand.Slot
...
# set data
    execute in world:admin_area run item modify block 0 0 0 container.0 asset:dynamic_lore/lightning_wand

# give item
    function asset:item/lightning_wand/lore/give_item with storage asset: __temp__
...
# remove the item
    ...
    data remove storage asset: lightning_wand
...
# loop
    ...
    execute if data storage asset: Inventory[] run function asset:item/lightning_wand/lore/modify