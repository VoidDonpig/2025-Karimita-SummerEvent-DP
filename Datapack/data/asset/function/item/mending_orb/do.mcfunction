#> asset:item/mending_orb/do
#
# ablity process
#
# @within asset:item/mending_orb/
...
# summon
    execute at @s positioned ~ ~1.0 ~ summon minecraft:armor_stand run function asset:item/mending_orb/summon
    tag @s remove this