...
# copy item
    data modify storage asset: frost_wand set from storage asset: Inventory[0]

# updates shulker box
    data modify storage asset: __temp__.Slot set string storage asset: frost_wand.Slot 0 -1
    data remove storage asset: frost_wand.Slot
...
# give item
    function asset:item/frost_wand/lore/give_item with storage asset: __temp__
