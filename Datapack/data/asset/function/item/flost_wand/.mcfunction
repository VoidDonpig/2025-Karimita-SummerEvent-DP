...
# check
    ...
    function player:status/cooltime/check {name:flost_wand}
    execute if entity @s[tag=cooltime_ok] run function player:status/mana/use/check

# fail
    execute unless entity @s[tag=cooltime_ok] run function player:status/cooltime/fail {name:flost_wand}
    execute if entity @s[tag=cooltime_ok] unless entity @s[tag=mana_ok] run function player:status/mana/use/fail

# run
    execute if entity @s[tag=cooltime_ok] if entity @s[tag=mana_ok] run function asset:item/flost_wand/do
