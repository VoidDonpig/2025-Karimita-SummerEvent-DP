#> asset:item/recovery_orb/summon
#
# summon asset
#
...
# set data
    data merge entity @s {data:{asset:{id:recovery_orb}},CustomNameVisible:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["asset","autokill"],DisabledSlots:4144959,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjBkZTVlODk3NDk0MDM3NTkzNGQzMmY3MWM5MWFkMmQ1NzI4ZDM4ZTUxNjQ3ZGNjOGYzOTIwNmMwOTlhNTRjMiJ9fX0="}]}}}},CustomName:{"bold":true,"color":"dark_purple","text":"リカバリーオーブ"}}
