#> asset:item/dungeon_torch/deactivate/modify
#
# modify torch
#
# @within asset:item/dungeon_torch/deactivate/
...
# set data
    execute in world:admin_area run item modify block 0 0 0 container.0 asset:item/dungeon_torch/remove

# give item
    function asset:item/dungeon_torch/deactivate/give_item with storage asset: __temp__
