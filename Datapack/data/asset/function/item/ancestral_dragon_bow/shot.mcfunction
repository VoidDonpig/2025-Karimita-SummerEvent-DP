...
# shoot arrows
    ...
    execute as @n[tag=not_init_arrow,tag=ancestral_dragon_bow_arrow] run data modify entity @s Motion set from entity 83a-51-1-0-1 Pos
    damage @n[tag=not_init_arrow,tag=ancestral_dragon_bow_arrow] 0.0
