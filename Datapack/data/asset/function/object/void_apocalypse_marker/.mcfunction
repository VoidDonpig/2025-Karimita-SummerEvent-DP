...
# get victim
    ...
    execute positioned ~-4.5 ~ ~-4.5 as @a[tag=victim] unless entity @a[dx=8,dy=255,dz=8] run tag @s remove victim
...
# deadly damage
    ...
    # damage
        execute if score @s asset_timer.1 matches 100.. as @a[tag=victim] run damage @s 45 magic
