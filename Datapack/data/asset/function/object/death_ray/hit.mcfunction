...
# damage
    execute positioned ~-2.5 ~-2.5 ~-2.5 as @e[type=#lib:all,type=!#lib:monster,dx=4,dy=4,dz=4] run damage @s 340282346638528860000000000000000000000 minecraft:explosion
