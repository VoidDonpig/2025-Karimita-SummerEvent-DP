...
# sfx
    execute if score @s asset_timer.1 matches ..39 run particle white_smoke ~ ~ ~ 0.4 0.4 0.4 0.2 32 force @a
    execute if score @s asset_timer.1 matches ..39 run particle large_smoke ~ ~ ~ 0.4 0.4 0.4 0.2 32 force @a
