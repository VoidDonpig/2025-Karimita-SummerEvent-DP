...
# count item
    execute store result score $needed_items temporary run data get entity @s data.crafting_item.recipe_components[0].count
...
# repeat
    ...
    execute unless data entity @s data.crafting_item.recipe_components[0] run scoreboard players reset $needed_items temporary
    execute unless data entity @s data.crafting_item.recipe_components[0] run scoreboard players reset $custom temporary
    execute unless data entity @s data.crafting_item.recipe_components[0] run scoreboard players reset $count temporary
    ...
    execute if data entity @s data.crafting_item.recipe_components[0] run function ui:crafter/page/weapon/craft/count_item with entity @s data.crafting_item.recipe_components[0]