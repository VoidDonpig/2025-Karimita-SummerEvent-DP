particle soul_fire_flame ~-0.5 ~-0.5 ~-0.5 ~10000000 ~ ~ 0.0000000066 0 normal
    particle soul_fire_flame ~0.5 ~-0.5 ~-0.5 ~ ~ ~10000000 0.0000000066 0 normal
    particle soul_fire_flame ~0.5 ~-0.5 ~0.5 ~-10000000 ~ ~ 0.0000000066 0 normal
    particle soul_fire_flame ~-0.5 ~-0.5 ~0.5 ~ ~ ~-10000000 0.0000000066 0 normal
    ...
    particle soul_fire_flame ~0.5 ~-0.5 ~0.5 ~ ~10000000 ~ 0.0000000066 0 normal
    particle soul_fire_flame ~-0.5 ~0.5 ~0.5 ~ ~-10000000 ~ 0.0000000066 0 normal
    particle sculk_soul ~ ~ ~ 0.1 0.1 0.1 0.04 1 normal
    ...
    execute if predicate {"condition": "entity_properties","entity": "this","predicate": {"periodic_tick": 80}} run playsound minecraft:block.respawn_anchor.deplete hostile @a[distance=..16] ~ ~ ~ 0.25 2 0
    ...
    particle dust{color:[0.122,0.973,1.000],scale:1.3} ~ ~ ~ 0.2 0.2 0.2 0 2 normal
    particle dust{color:[0.741,1.000,0.957],scale:1.3} ~ ~ ~ 0.2 0.2 0.2 0 2 normal

    particle trial_spawner_detection_ominous ~ ~ ~ 0.4 0.4 0.4 0 4 normal